<template>
  <div class="GET">
    <form class="form" action="">
      <p type="INSERTAR UNA ORDEN DE COMPRA:"></p>
      <p type="Precio: ">
        <input v-model="precio" type="text" />
      </p>
      <p type="ClienteId: ">
        <input v-model="clienteId" type="text" />
      </p>
      <p type="ProductoId: ">
        <input v-model="productoId" type="text" />
      </p>
    ...
    <form class="form" action="">
      ...
      <p type="ClienteId: ">
        <input v-model="body.clienteId" type="text" />
      </p>
      <p type="ProductoId: ">
        <input v-model="body.productoId" type="text" />
      </p>
    </form>
  </div>
  <div>
    ...
    <table>
      <tr>
        ...
        <td>productoId</td>
        <td>Precio</td>
        <td v-if="datosCargados">Eliminar Orden de Compra</td>
      </tr>
...
export default {
  ...
  methods: {
    async insertar() {
      if (this.clienteId && this.productoId && this.precio) {
        const pacBody = {
    ...
    async buscar() {
      if (this.id) {
        ...
        if (data) {
          this.body.clienteId = data.clienteId;
          this.body.productoId = data.productoId;
